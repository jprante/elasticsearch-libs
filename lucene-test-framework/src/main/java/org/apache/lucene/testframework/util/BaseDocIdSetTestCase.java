...
import static org.apache.lucene.testframework.util.BaseBitSetTestCase.randomSet;
...
public abstract class BaseDocIdSetTestCase<T extends DocIdSet> extends LuceneTestCase {
  ...
  public void testAgainstBitSet() throws IOException {
    ...
    for (float percentSet : new float[] {0f, 0.0001f, random().nextFloat(), 0.9f, 1f}) {
      final BitSet set = BaseBitSetTestCase.randomSet(numBits, percentSet);
  ...
  public void testRamBytesUsed() throws IOException {
    ...
    for (int i = 0; i < iters; ++i) {
      ...
      final BitSet set = BaseBitSetTestCase.randomSet(maxDoc, numDocs);

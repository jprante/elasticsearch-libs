...
import org.apache.lucene.testframework.codecs.compressing.CompressingCodec;
import org.apache.lucene.codecs.lucene50.Lucene50StoredFieldsFormat;
import org.apache.lucene.codecs.lucene70.Lucene70Codec;
import org.apache.lucene.testframework.codecs.mockrandom.MockRandomPostingsFormat;
import org.apache.lucene.codecs.simpletext.SimpleTextCodec;
import org.apache.lucene.testframework.index.RandomCodec;
import org.apache.lucene.testframework.search.similarities.RandomSimilarity;
...
final class TestRuleSetupAndRestoreClassEnv extends AbstractBeforeAfterRule {
  ...
  /**
   * @see LuceneTestCase.SuppressCodecs
   */
  ...
  protected void before() throws Exception {
    ...
    } else if ("Asserting".equals(LuceneTestCase.TEST_CODEC) || ("random".equals(LuceneTestCase.TEST_CODEC) && randomVal == 7 && !shouldAvoidCodec("Asserting"))) {
      codec = new AssertingCodec();
    } else if ("Compressing".equals(LuceneTestCase.TEST_CODEC) || ("random".equals(LuceneTestCase.TEST_CODEC) && randomVal == 6 && !shouldAvoidCodec("Compressing"))) {
      codec = CompressingCodec.randomInstance(random);
    } else if ("Lucene70".equals(LuceneTestCase.TEST_CODEC) || ("random".equals(LuceneTestCase.TEST_CODEC) && randomVal == 5 && !shouldAvoidCodec("Lucene70"))) {
    ...
    locale = testLocale.equals("random") ? randomLocale : LuceneTestCase.localeForLanguageTag(testLocale);
    ...
    similarity = new RandomSimilarity(LuceneTestCase.random());
  ...
  private void checkCodecRestrictions(Codec codec) {
    ...
    LuceneTestCase.assumeFalse("Class not allowed to use postings format: " + LuceneTestCase.TEST_POSTINGSFORMAT + ".",

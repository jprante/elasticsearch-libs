...
public class TestRuleLimitSysouts extends TestRuleAdapter {
  ...
  protected boolean isEnforced() {
    ...
    if (LuceneTestCase.VERBOSE || 
        ...
        target.isAnnotationPresent(LuceneTestCase.Monster.class) ||
        target.isAnnotationPresent(LuceneTestCase.SuppressSysoutChecks.class)) {
      return false;
    }
    ...
    if (isEnforced()) {
      ...
      if (bytesWritten.get() >= limit && failureMarker.wasSuccessful()) {
        throw new AssertionError(String.format(Locale.ENGLISH, 
            ...
            LuceneTestCase.SuppressSysoutChecks.class.getSimpleName()));
      }
    }
  }

...
import org.apache.lucene.testframework.mockfile.DisableFsyncFS;
import org.apache.lucene.testframework.mockfile.ExtrasFS;
import org.apache.lucene.testframework.mockfile.HandleLimitFS;
import org.apache.lucene.testframework.mockfile.LeakFS;
import org.apache.lucene.testframework.mockfile.ShuffleFS;
import org.apache.lucene.testframework.mockfile.VerboseFS;
import org.apache.lucene.testframework.mockfile.WindowsFS;
      ...
      try {
        ...
        if (suiteClass.isAnnotationPresent(LuceneTestCase.SuppressTempFileChecks.class)) {
          System.err.println("WARNING: Leftover undeleted temporary files (bugUrl: "
              + suiteClass.getAnnotation(LuceneTestCase.SuppressTempFileChecks.class).bugUrl() + "): "
              + e.getMessage());
          return;
        }
        throw e;

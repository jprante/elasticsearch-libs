...
public class TestExceptionInBeforeClassHooks extends WithNestedTests {
  ...
  public static class Nested1 extends AbstractNestedTest {
    @BeforeClass
  ...
  public static class Nested2 extends AbstractNestedTest {
  ...
  public static class Nested3 extends AbstractNestedTest {
    @Before

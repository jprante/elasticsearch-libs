...
public final class RandomizedRunner extends Runner implements Filterable {
   ...
   */
  final static Logger logger = Logger.getLogger(RandomizedRunner.class.getName());
  ...
  private void restoreSystemProperties() {
    for (Map.Entry<String,String> e : restoreProperties.entrySet()) {
      try {
        ...
        logger.log(Level.WARNING, "Could not restore system property: " + e.getKey() + " => " + e.getValue());
      }
    }
  }
  ...
  private void processSystemProperties() {
    try {
      ...
      logger.log(Level.WARNING, "Could not set child VM count and ID properties.");
    }
  }

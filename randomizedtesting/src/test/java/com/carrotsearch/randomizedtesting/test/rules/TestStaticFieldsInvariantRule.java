package com.carrotsearch.randomizedtesting.test.rules;
...
public class TestStaticFieldsInvariantRule extends WithNestedTestClass {
  ...
  public void testJavaModule() {
    // check if we have Java module system
    try {
      Class.class.getMethod("getModule");
    } catch (Exception e) {
      RandomizedTest.assumeTrue("This test requires Java module system", false);
    }

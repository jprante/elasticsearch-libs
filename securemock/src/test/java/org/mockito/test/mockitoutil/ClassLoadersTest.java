 ...
 */
package org.mockito.test.mockitoutil;
...
import static org.mockito.test.mockitoutil.ClassLoaders.currentClassLoader;
import static org.mockito.test.mockitoutil.ClassLoaders.excludingClassLoader;
import static org.mockito.test.mockitoutil.ClassLoaders.isolatedClassLoader;
import static org.mockito.test.mockitoutil.ClassLoaders.jdkClassLoader;
...
public class ClassLoadersTest {
    ...
    public void isolated_class_loader_cannot_load_classes_if_dependent_classes_do_not_match_the_prefixes() throws Exception {
        ...
        try {
            ...
            // then
            assertThat(e).hasMessageContaining("org/mockito/test/mockitoutil/ClassLoadersTest$Interface1");
        }
    }
        ...
        ClassLoaders.using(cl).execute(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    assertThat(Thread.currentThread()
                                     .getContextClassLoader()
                                     .loadClass("org.mockito.test.mockitoutil.ClassLoadersTest$ClassUsingInterface1"))

...
public class MatchersTest extends TestBase {
    ...
    public void any_T_matcher() {
        ...
        when(mock.oneArg((String) any())).thenReturn("8");
        when(mock.oneArg((Byte) any())).thenReturn("9");
    ...
    public void null_matcher_for_primitive_wrappers() {
        ...
        when(mock.forInteger(isNull())).thenReturn("ok");
        when(mock.forLong(isNull())).thenReturn("ok");
        when(mock.forByte(isNull())).thenReturn("ok");
        when(mock.forShort(isNull())).thenReturn("ok");
        when(mock.forCharacter(isNull())).thenReturn("ok");
        when(mock.forDouble(isNull())).thenReturn("ok");
        when(mock.forFloat(isNull())).thenReturn("ok");
    ...
    public void eq_matcher_and_nulls() {
        ...
        verify(mock).simpleMethod(eq((String) null));
    }
    ...
    public void same_matcher_and_nulls() {
        ...
        verify(mock).simpleMethod(same((String) null));
    }

...
package org.mockito.test.mockitousage.examples.use;
...
public class ExampleTest {
    ...
    public void shouldPersistRecalculatedArticle() {
        ...
        inOrder.verify(mockCalculator).countNumberOfRelatedArticles((Article) any());
        inOrder.verify(mockDatabase, atLeastOnce()).save((Article) any());
    }
}

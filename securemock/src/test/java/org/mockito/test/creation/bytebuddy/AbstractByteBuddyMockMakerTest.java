 ...
 */
package org.mockito.test.creation.bytebuddy;
...
import org.mockito.test.mockitoutil.ClassLoaders;
import org.mockito.test.mockitoutil.SimpleSerializationUtil;
...
public abstract class AbstractByteBuddyMockMakerTest<MM extends MockMaker> {
    ...
    public class ClassWithDodgyConstructor {
    ...
    public void instantiate_fine_when_objenesis_on_the_classpath() throws Exception {
        ...
        // when
        mock_maker_class_loaded_fine_until.getDeclaredConstructor().newInstance();
    ...
    public static class CallingSuperMethodClass extends SampleClass {
        @Override
        public String foo() {
            return super.foo();
        }

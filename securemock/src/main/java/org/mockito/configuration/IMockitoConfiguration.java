...
public interface IMockitoConfiguration {
    ...
    void overrideDefaultAnswer(Answer<Object> defaultAnswer);

    void overrideCleansStackTrace(boolean cleansStackTrace);

    void overrideAnnotationEngine(AnnotationEngine engine);

    void overrideEnableClassCache(boolean enableClassCache);
}

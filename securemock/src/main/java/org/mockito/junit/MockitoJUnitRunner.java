 ...
 * Make sure to try out {@link StrictStubs} which automatically
 ...
 *   <li>
 *      It is highly recommended to use {@link StrictStubs} variant of the runner.
...
public class MockitoJUnitRunner extends Runner implements Filterable {
     ...
     * stubbing argument mismatches ({@link StrictStubs})
    ...
    public MockitoJUnitRunner(InternalRunner runner) throws InvocationTargetException {
        this.runner = runner;
    }

...
public final class FrenchAnalyzer extends StopwordAnalyzerBase {
  ...
  private static class DefaultSetHolder {
    ...
    static {
      try {
        DEFAULT_STOP_SET = loadSnowballStopwordSet(false, SnowballFilter.class, DEFAULT_STOPWORD_FILE);
  ...
  /**
   * Creates
   * {@link Analyzer.TokenStreamComponents}
   * used to tokenize all the text in the provided {@link Reader}.
   *
   * @return {@link Analyzer.TokenStreamComponents}

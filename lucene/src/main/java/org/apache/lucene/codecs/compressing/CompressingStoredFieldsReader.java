...
public final class CompressingStoredFieldsReader extends StoredFieldsReader {
   ...
   */
  public static float readZFloat(DataInput in) throws IOException {
   ...
   */
  public static double readZDouble(DataInput in) throws IOException {
    int b = in.readByte() & 0xFF;
    if (b == 0xFF) {
      // negative value
   ...
   */
  public static long readTLong(DataInput in) throws IOException {

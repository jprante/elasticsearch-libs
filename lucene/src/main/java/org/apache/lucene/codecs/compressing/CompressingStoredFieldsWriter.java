...
public final class CompressingStoredFieldsWriter extends StoredFieldsWriter {
   ...
   * </ul>
   */
  public static void writeZFloat(DataOutput out, float f) throws IOException {
    int intVal = (int) f;
   ...
   * </ul>
   */
  public static void writeZDouble(DataOutput out, double d) throws IOException {
    int intVal = (int) d;
   ...
   */
  // T for "timestamp"
  public static void writeTLong(DataOutput out, long l) throws IOException {
    int header; 
    if (l % SECOND != 0) {
      header = 0;
    } else if (l % DAY == 0) {

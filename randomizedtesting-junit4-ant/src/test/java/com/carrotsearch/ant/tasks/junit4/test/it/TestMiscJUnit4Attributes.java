...
import com.carrotsearch.ant.tasks.junit4.test.donotexecute.TestAfterClassError;
import com.carrotsearch.ant.tasks.junit4.test.donotexecute.TestBeforeClassError;
...
public class TestMiscJUnit4Attributes extends JUnit4XmlTestBase {
  ...
  public void assertions() {
    ...
    assertLogContains("java.lang.AssertionError: foobar");
  }

  @Test
  public void balancing() {
    executeTarget("balancing");
    assertLogContains("Assignment hint: J0  (cost  2019) com.carrotsearch.ant.tasks.junit4.test.donotexecute.sub2.TestTwoSeconds (by ExecutionTimeBalancer)");
    assertLogContains("Assignment hint: J1  (cost  1002) com.carrotsearch.ant.tasks.junit4.test.donotexecute.sub2.TestOneSecond (by ExecutionTimeBalancer)");
    assertLogContains("Assignment hint: J1  (cost   501) com.carrotsearch.ant.tasks.junit4.test.donotexecute.sub2.TestHalfSecond (by ExecutionTimeBalancer)");
    assertLogContains("Assignment hint: J1  (cost     2) com.carrotsearch.ant.tasks.junit4.test.donotexecute.sub2.TestZeroSeconds (by ExecutionTimeBalancer)");
  }

...
import com.carrotsearch.ant.tasks.junit4.test.donotexecute.FailInAfterClass;
import com.carrotsearch.ant.tasks.junit4.test.donotexecute.ReasonForAssumptionIgnored;
...
public class TestTextReport extends JUnit4XmlTestBase {
  ...
  public void listeners() {
    ...
    assertLogContains("testStarted: passing(com.carrotsearch.ant.tasks.junit4.test.donotexecute.SuiteListeners)");
    assertLogContains("testFinished: passing(com.carrotsearch.ant.tasks.junit4.test.donotexecute.SuiteListeners)");
  }

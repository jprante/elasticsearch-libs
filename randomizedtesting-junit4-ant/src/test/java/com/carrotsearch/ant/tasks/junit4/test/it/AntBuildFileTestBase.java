...
import static org.apache.tools.ant.ProjectHelper.PROJECTHELPER_REFERENCE;
...
public class AntBuildFileTestBase {
  ...
  protected void setupProject(URL url) {
    ...
    project.setUserProperty(MagicNames.ANT_FILE, url.toExternalForm());
    project.setProperty("basedir", "build");
    configureProject(project, url);
  ...
  public static void configureProject(Project project, URL url) throws BuildException {
